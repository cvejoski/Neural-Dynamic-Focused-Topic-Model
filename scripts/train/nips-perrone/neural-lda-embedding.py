...
# data_dir = os.path.join(data_path, "preprocessed", "nips-perrone", "language", "0.5")

training = True
if __name__ == "__main__":
    for number_of_topics in [50]:
        for rec_layers in [[256, 256]]:
            for lr in [0.001]:
                for bs in [100]:
                    for i in [0.5, 0.6, 0.7, 0.8]:
                        ...
                        ndt_parameters.update({'experiment_name': f'nips-perrone-embeddings-256-256-100-split-{i}'})
