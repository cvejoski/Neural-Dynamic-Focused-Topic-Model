                        ...
                        for emb_dim in [64]:
                            for dynamic_topics in ["static"]:
                                for diversity in [0.1]:
                                    for alpha0 in [0.1, 0.5, 1.0]:
                                        for i in range(87, 89):
                                            data_dir = os.path.join(data_path, "preprocessed", "nips", "language", str(i))
                                            ...
                                            experiment_name = f'nips-{dynamic_topics}--transition-n-topics-{number_of_topics}-pi-{alpha0}-lr-{lr}-split-{i}'
